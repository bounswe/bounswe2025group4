...
class MentorshipServiceImplTest {
        ...
        void uploadResumeFile_success_publicBucket() throws Exception {
                ...
                ResumeFileResponseDTO response = mentorshipService.uploadResumeFile(reviewId, file);
        ...
        void createMentorProfile_userNotFound_throws() {
                ...
                assertThrows(
                                HandleException.class,
                                () -> mentorshipService.createMentorProfile(10L,
                                                new CreateMentorProfileDTO(Collections.singletonList("Java"), 3)));
        }
        ...
        void createMentorProfile_alreadyExists_throws() {
                ...
                assertThrows(
                                HandleException.class,
                                () -> mentorshipService.createMentorProfile(userId,
                                                new CreateMentorProfileDTO(Collections.singletonList("Java"), 3)));
        }
        ...
        void respondToMentorshipRequest_accept_success() {
                ...
                MentorshipRequestResponseDTO result = mentorshipService.respondToMentorshipRequest(requestId, dto,
                                mentorUserId);
        ...
        void respondToMentorshipRequest_decline_success() {
                ...
                RespondToRequestDTO dto = new RespondToRequestDTO(false, "Sorry, I don't have capacity right now.");
        ...
        void respondToMentorshipRequest_unauthorizedMentor_throws() {
                ...
                RespondToRequestDTO dto = new RespondToRequestDTO(true, "Some message");
